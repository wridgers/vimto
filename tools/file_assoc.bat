...
:: file extensions
set EXT_LIST=(asc bib c cfg coffee conf cpp css ejs frag fp glsl gpg go h hpp hs ini jade js json less org pgp php php4 php5 phps pl py rb scss sh vert vim vp xml lua log markdown md nfo tex text txt yaml yml)
